...
export default function Store() {
    ...
    const products = [
        {
            image: 'https://media.istockphoto.com/id/1124394341/photo/colorful-piano-key-board.jpg?s=612x612&w=0&k=20&c=C2ld3WdyXxJYcUoE4qne1DvC9PDsz_1mC5SgS7_W4ks=',
            isNew: true,
            isSale: true,
            sale: 30,
            price: 980,
                ...
                <div class="row">
                    ...
                    <div id="store" class="col-md-9">
                        <div class="store-filter clearfix">
                            ...
                            <ul class="store-grid">
                                <li class="active"><i><Icon icon="fa:th" /></i></li>
